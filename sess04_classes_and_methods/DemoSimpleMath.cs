...
/// <summary>
/// Program to demonstrate the static and overloaded methods in the SimpleMath class.
/// </summary>
public class DemoSimpleMath
{
    static void Main(string[] args)
    {
        ...
        for (uint n = 0; n < scores.Length; n++)
        {
            ...
            // Console.Write(n < (scores.Length - 1)? $"{scores[n]}, ": $" and {scores[n]},");
        }
        ...
        Console.WriteLine($"The sum of {firstNum} + {secondNum} + {thirdNum} = " +
                          $"{SimpleMath.AddNums(num3:thirdNum, num1:firstNum,num2:secondNum)}");
        Console.WriteLine(new string('-', 50));
    }
}